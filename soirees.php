            ...
            <script>
                $(document).ready(function() {
                    $.fn.load_new_content = function(){
                        ...
                        if (model == "Action") {
                            $("#img-resize").html("<?php while($soireesAction_sortInfos = $soireesAction_sort->fetch()){ ?> <div class='col-12 col-sm-6 col-lg-4 col-xl-3'><div class='card p-0 h-auto'><img src='./assets/images/looking_into_my_soul.png' class='card-img-top object-fit-cover' alt='...'><div class='card-body bg-ctm-primary-color-subtle'><h5 class='card-title'><?php echo addslashes($soireesAction_sortInfos['nom_film']);?></h5><p class='card-text lh-1'><?php echo addslashes($soireesAction_sortInfos['synopsis']);?></p></div> <div class='card-footer p-0 border-0'> <a href='#' class='btn btn-ctm-red py-3 w-100 rounded-0 rounded-bottom-1'>Go somewhere</a> </div> </div></div> <?php } ?>");
                        } else if (model == "Fantastique") {
                            $("#img-resize").html("<?php while($soireesFanstastique_sortInfos = $soireesFanstastique_sort->fetch()){ ?> <div class='col-12 col-sm-6 col-lg-4 col-xl-3'><div class='card p-0 h-auto'><img src='./assets/images/looking_into_my_soul.png' class='card-img-top object-fit-cover' alt='...'><div class='card-body bg-ctm-primary-color-subtle'><h5 class='card-title'><?php echo addslashes($soireesFanstastique_sortInfos['nom_film']);?></h5><p class='card-text lh-1'><?php echo addslashes($soireesFanstastique_sortInfos['synopsis']);?></p></div> <div class='card-footer p-0 border-0'> <a href='#' class='btn btn-ctm-red py-3 w-100 rounded-0 rounded-bottom-1'>Go somewhere</a> </div> </div></div> <?php } ?>");
                        } else if (model == "Horreur") {
                            $("#img-resize").html("<?php while($soireesHorreur_sortInfos = $soireesHorreur_sort->fetch()){ ?> <div class='col-12 col-sm-6 col-lg-4 col-xl-3'><div class='card p-0 h-auto'><img src='./assets/images/looking_into_my_soul.png' class='card-img-top object-fit-cover' alt='...'><div class='card-body bg-ctm-primary-color-subtle'><h5 class='card-title'><?php echo addslashes($soireesHorreur_sortInfos['nom_film']);?></h5><p class='card-text lh-1'><?php echo addslashes($soireesHorreur_sortInfos['synopsis']);?></p></div> <div class='card-footer p-0 border-0'> <a href='#' class='btn btn-ctm-red py-3 w-100 rounded-0 rounded-bottom-1'>Go somewhere</a> </div> </div></div> <?php } ?>");
                        } else if (model == "Animation") {
                            $("#img-resize").html("<?php while($soireesAnimation_sortInfos = $soireesAnimation_sort->fetch()){ ?> <div class='col-12 col-sm-6 col-lg-4 col-xl-3'><div class='card p-0 h-auto'><img src='./assets/images/looking_into_my_soul.png' class='card-img-top object-fit-cover' alt='...'><div class='card-body bg-ctm-primary-color-subtle'><h5 class='card-title'><?php echo addslashes($soireesAnimation_sortInfos['nom_film']);?></h5><p class='card-text lh-1'><?php echo addslashes($soireesAnimation_sortInfos['synopsis']);?></p></div> <div class='card-footer p-0 border-0'> <a href='#' class='btn btn-ctm-red py-3 w-100 rounded-0 rounded-bottom-1'>Go somewhere</a> </div> </div></div> <?php } ?>");
                        } else if (model == "Comédie") {
                            $("#img-resize").html("<?php while($soireesComedy_sortInfos = $soireesComedy_sort->fetch()){ ?> <div class='col-12 col-sm-6 col-lg-4 col-xl-3'><div class='card p-0 h-auto'><img src='./assets/images/looking_into_my_soul.png' class='card-img-top object-fit-cover' alt='...'><div class='card-body bg-ctm-primary-color-subtle'><h5 class='card-title'><?php echo addslashes($soireesComedy_sortInfos['nom_film']);?></h5><p class='card-text lh-1'><?php echo addslashes($soireesComedy_sortInfos['synopsis']);?></p></div> <div class='card-footer p-0 border-0'> <a href='#' class='btn btn-ctm-red py-3 w-100 rounded-0 rounded-bottom-1'>Go somewhere</a> </div> </div></div> <?php } ?>");
                        } else if (model == "Historique") {
                            $("#img-resize").html("<?php while($soireesHistorique_sortInfos = $soireesHistorique_sort->fetch()){ ?> <div class='col-12 col-sm-6 col-lg-4 col-xl-3'><div class='card p-0 h-auto'><img src='./assets/images/looking_into_my_soul.png' class='card-img-top object-fit-cover' alt='...'><div class='card-body bg-ctm-primary-color-subtle'><h5 class='card-title'><?php echo addslashes($soireesHistorique_sortInfos['nom_film']);?></h5><p class='card-text lh-1'><?php echo addslashes($soireesHistorique_sortInfos['synopsis']);?></p></div> <div class='card-footer p-0 border-0'> <a href='#' class='btn btn-ctm-red py-3 w-100 rounded-0 rounded-bottom-1'>Go somewhere</a> </div> </div></div> <?php } ?>");
                        } else if (model == "Thriller") {
                            $("#img-resize").html("<?php while($soireesThriller_sortInfos = $soireesThriller_sort->fetch()){ ?> <div class='col-12 col-sm-6 col-lg-4 col-xl-3'><div class='card p-0 h-auto'><img src='./assets/images/looking_into_my_soul.png' class='card-img-top object-fit-cover' alt='...'><div class='card-body bg-ctm-primary-color-subtle'><h5 class='card-title'><?php echo addslashes($soireesThriller_sortInfos['nom_film']);?></h5><p class='card-text lh-1'><?php echo addslashes($soireesThriller_sortInfos['synopsis']);?></p></div> <div class='card-footer p-0 border-0'> <a href='#' class='btn btn-ctm-red py-3 w-100 rounded-0 rounded-bottom-1'>Go somewhere</a> </div> </div></div> <?php } ?>");
