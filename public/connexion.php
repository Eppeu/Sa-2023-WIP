<!-- 
connexion.php - Connexion PopCo
Cette page est utilisée quand un utilisateur souhaite se connecter à son compte.
-->
...
<body class="bg-ctm-terciary-color">
    ...
    <main>
        ...
        <!-- Cette partie de PHP fait juste une vérification quand l'utilisateur rentre son mot de pasee ou identifiant
        Si il n'y arrive pas, une alerte sera remplacée du message avant -->
            <?php 
            if ($error != 1 ) {
                echo
                '
