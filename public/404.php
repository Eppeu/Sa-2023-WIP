<!-- 
404 - Erreur 404
Cette page est utilisée quand un utilisateur rentre une URL fausse, elle est là afin de renvoyer
vers une page 404 et lui permet de revenir sur la page principale de PopCo
-->
    ...
    <main class="container-fluid px-0">
        ...
        <div class ="text-center row">
            <figure class = "figure mt-5">
                <img src="../assets/icons/PopCo_logo_error.png" class="img-create img-fluid rounded-2" alt="PopCo Logo au sol">
            </figure>
            <h1> Erreur 404</h1>
            <p>La page que vous avez cherché n'existe pas</p>
            <a class="btn btn-ctm-red col-6 mx-auto mb-4" href="../public/index">Accueil</a>
        </div>
